            ...
            <Row className="row-home">
              <Col className="d-flex justify-content-center">
                ...
                <div className="order-sm-first">
                  ...
                  <p>
                    Contáctanos y cuéntanos acerca de tus proyectos
                    universitarios, empresariales o personales, relacionados con
                    electrónica, en los cuales necesitas ayuda. Con gusto te
                    brindaremos el mejor desarrollo o la mejor solución si está
                    a nuestro alcance.
                  </p>
                </div>
              </Col>
            ...
            <Row className="row-home">
              <Col className="d-flex justify-content-center">
                ...
                <div>
                  ...
                  <p>
                    Por compras superiores a $90.000 COP tu envío será
            ...
            <Row className="row-home">
              <Col className="d-flex justify-content-center">
                ...
                <div className="order-sm-first">
                  ...
                  <p>
                    Recibirás tu pedido de manera facil, confiable, segura y con
                    la mejor calidad.
                  </p>
                </div>
              </Col>
            ...
            <Row className="row-home">
              <Col className="d-flex justify-content-center">
                ...
                <div>
                  ...
                  <p>
                    Por compras superiores a $70.000 COP recibe un 5% de
                    descuento.
                  </p>
                </div>
              </Col>
